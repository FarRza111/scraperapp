...
country_urls = [
    ...
    'https://bank.codes/iban/structure/albania/',
    ...
    try:
        ...
        for table in tables:
            ...
            for row in rows:
                ...
                country_data[label] = value 
                # Add to the country data dictionary
        ...
        result = list(filter(None, extracted_values))

        temp = {"fulldetail": result}
        data.append(temp)
...
# df.to_excel('account_info_details.xlsx', index=False)
# print(df_fin)
df.to_excel('account_info_details.xlsx', index=False)
